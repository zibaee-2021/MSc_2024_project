...
class ColNames(Enum):
    ...
    BB_ATOM_POS = 'bb_atom_pos'              # POSITION OF 1 OUT OF 5 BACKBONE ATOMS. 'CA' ELSE MOST C-TERM ALTERNATIVE.
    BBINDICES = 'bbindices'                  # INDEX POSITION OF THE ATOM POSITION (`A_id`) OF ALLOCATED BACKBONE ATOM.
